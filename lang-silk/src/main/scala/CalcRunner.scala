...
import net.codingwell.weave.languages.silk.Preprocessor
...
class CalcRunner {
	def Run =
	{
		...
		val parser = new net.codingwell.weave.languages.silk.SilkParser(buffer)// { override val buildParseTree = true }
