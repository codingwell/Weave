...
public class SilkParser extends BaseParser<SilkFile>
{
	...
	public Rule Using(Var<SilkFile> file)
	{
		...
		return Sequence(
			...
			act.Using_Post(file.get(), using.get(), match())
		);
	}
	...
	Rule Number()
	{
        return Sequence(
            ...
            EMPTY//push(new CalcNode(Double.parseDouble(matchOrDefault("0")))),
        );
    }
	...
	/**
	 * @brief Determines if the current character is a Unicode whitespace character.
	 * 
	 * This function does not support supplementary characters (Multibyte UTF-16)
	 * 
	 * @return Rule
	 */
	@Label("Whitespace")
