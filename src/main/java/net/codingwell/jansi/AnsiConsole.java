...
public class AnsiConsole
{
    ...
    */
   synchronized static public void systemInstall( boolean force )
   {
      final PrintStream out = new PrintStream(wrapOutputStream(system_out,force));
      final PrintStream err = new PrintStream(wrapOutputStream(system_err,force));
